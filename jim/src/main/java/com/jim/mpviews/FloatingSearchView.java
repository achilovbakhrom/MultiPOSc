...
import com.jim.mpviews.adapters.GestureDetectorListenerAdapter;
import com.jim.mpviews.adapters.OnItemTouchListenerAdapter;
import com.jim.mpviews.adapters.TextWatcherAdapter;
import com.jim.mpviews.suggestions.SearchSuggestionsAdapter;
import com.jim.mpviews.suggestions.model.SearchSuggestion;
import com.jim.mpviews.utils.Utils;
import com.jim.mpviews.view.SearchInputView;
...
public class FloatingSearchView extends FrameLayout {
    ...
    private LinearLayout mQuerySection;
    ...
    private void init(AttributeSet attrs) {
        ...
        mHostActivity = Utils.getHostActivity(getContext());

        LayoutInflater layoutInflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMainLayout = inflate(getContext(), R.layout.floating_search_layout, this);
        mBackgroundDrawable = new ColorDrawable(Color.BLACK);

        mQuerySection = (LinearLayout) findViewById(R.id.search_query_section);
    ...
    private void initDrawables() {
        ...
        mIconClear = Utils.getWrappedDrawable(getContext(), R.drawable.ic_clear_black_24dp);
        mIconBackArrow = Utils.getWrappedDrawable(getContext(), R.drawable.ic_arrow_back_black_24dp);
        mIconSearch = Utils.getWrappedDrawable(getContext(), R.drawable.ic_search_black_24dp);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mIsInitialLayout) {
            ...
            int addedHeight = 3 * Utils.dpToPx(CARD_VIEW_CORNERS_AND_TOP_BOTTOM_SHADOW_HEIGHT);
            ...
            vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (mSuggestionsSection.getHeight() == finalHeight) {
                        Utils.removeGlobalLayoutObserver(mSuggestionListContainer, this);
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            int cardPadding = Utils.dpToPx(CARD_VIEW_TOP_BOTTOM_SHADOW_HEIGHT);
            ...
            setSuggestionItemTextSize(a.getDimensionPixelSize(
                    ...
                    Utils.spToPx(ATTRS_SUGGESTION_TEXT_SIZE_SP_DEFAULT)));
            ...
            setClearBtnColor(a.getColor(R.styleable.FloatingSearchView_floatingSearch_clearBtnColor
                    , Utils.getColor(getContext(), R.color.clear_btn_color)));
            int viewTextColor = a.getColor(R.styleable.FloatingSearchView_floatingSearch_viewTextColor
                    , Utils.getColor(getContext(), R.color.dark_gray));
    ...
    private void setupQueryBar() {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                Utils.removeGlobalLayoutObserver(mQuerySection, this);
            }
        });
...
//                }
    ...
    private void handleOnVisibleMenuItemsWidthChanged(int menuItemsWidth) {
        if (menuItemsWidth == 0) {
            mClearButton.setTranslationX(-Utils.dpToPx(4));
            int paddingRight = Utils.dpToPx(4);
            if (mIsFocused) {
                paddingRight += Utils.dpToPx(CLEAR_BTN_WIDTH_DP);
            } else {
                paddingRight += Utils.dpToPx(14);
            }
    ...
    private void refreshLeftIcon() {
        int leftActionWidthAndMarginLeft = Utils.dpToPx(LEFT_MENU_WIDTH_AND_MARGIN_START_DP);
    ...
    private void setupSuggestionSection() {
                ...
                new GestureDetectorListenerAdapter() {
                    ...
                    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                        if (mHostActivity != null) {
                            Utils.closeSoftKeyboard(mHostActivity);
                        }
                        return false;
                    }
                });
        ...
        int cardViewBottomPadding = Utils.dpToPx(CARD_VIEW_CORNERS_AND_TOP_BOTTOM_SHADOW_HEIGHT);
    ...
    public void setQueryError(CharSequence text){
        mSearchInput.setError(text);
    }
    ...
    private void swapSuggestions(final List<? extends SearchSuggestion> newSearchSuggestions,
        ...
        mSuggestionsList.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                Utils.removeGlobalLayoutObserver(mSuggestionsList, this);
    ...
    private boolean updateSuggestionsSectionHeight(List<? extends SearchSuggestion>
        ...
        final int cardTopBottomShadowPadding = Utils.dpToPx(CARD_VIEW_CORNERS_AND_TOP_BOTTOM_SHADOW_HEIGHT);
        final int cardRadiusSize = Utils.dpToPx(CARD_VIEW_TOP_BOTTOM_SHADOW_HEIGHT);
    ...
    private void setSearchFocusedInternal(final boolean focused) {
        ...
        if (focused) {
            ...
            Utils.showSoftKeyboard(getContext(), mSearchInput);
            if (mMenuOpen) {
                closeMenu(false);
            }
            if (mIsTitleSet) {
...
//                    mLeftAction.setAlpha(0.0f);
//                    mLeftAction.setTranslationX(Utils.dpToPx(8));
...
//                            .translationX(-Utils.dpToPx(LEFT_MENU_WIDTH_AND_MARGIN_START_DP)).get();
//
