...
public abstract class DoubleSideActivity extends BaseActivity {
    ...
    protected final void addFragmentWithTagToLeft(Fragment fragment, String tag) {
        addFragmentWithTag(R.id.flLeftContainer, fragment, tag);
    }

    protected final void addFragmentWithBackStackToLeft(Fragment fragment) {
        addFragmentWithBackStack(R.id.flLeftContainer, fragment);
    }
    ...
    protected final void addFragmentWithTagToRight(Fragment fragment, String tag) {
        addFragmentWithTag(R.id.flRightContainer, fragment, tag);
    }

    protected final void addFragmentWithBackStackToRight(Fragment fragment) {
        addFragmentWithBackStack(R.id.flRightContainer, fragment);
    }
    ...
    protected final void addFragmentToRightWrap(Fragment fragment) {
        addFragment(R.id.flRightWrap, fragment);
    }

    protected final void addFragmentWithTagToTopRight(Fragment fragment, String tag) {
        addFragmentWithTag(R.id.flRightTop, fragment, tag);
    }

    protected final void addFragmentWithBackStackToTopRight(Fragment fragment) {
        addFragmentWithBackStack(R.id.flRightTop, fragment);
    }

    protected final void addFragmentToFull(Fragment fragment) {
        addFragment(R.id.flFullContainer, fragment);
    }

    protected final void addFragmentWithTagToFull(Fragment fragment, String tag) {
        addFragmentWithTag(R.id.flFullContainer, fragment, tag);
    }

    protected final void addFragmentWithTagToFullWindow(Fragment fragment, String tag) {
        addFragmentWithTagAndBackStack(R.id.flFull, fragment, tag);
    }

    protected final void addFragmentWithBackStackToFull(Fragment fragment) {
        addFragmentWithBackStack(R.id.flFullContainer, fragment);
    }
    ...
    protected final void replaceFragmentToTopRight(Fragment fragment) {
        replaceFragment(R.id.flRightTop, fragment);
    }

    protected final void replaceFragmentToRightWrap(Fragment fragment) {
        replaceFragment(R.id.flRightWrap, fragment);
    }

    protected final void replaceFragmentToFull(Fragment fragment) {
        replaceFragment(R.id.flFullContainer, fragment);
    }
