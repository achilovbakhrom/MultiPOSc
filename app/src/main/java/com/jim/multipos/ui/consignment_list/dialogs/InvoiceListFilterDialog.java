...
public class InvoiceListFilterDialog extends Dialog {
    ...
    MpButton btnApply;
    private InvoiceListFilterListener listener;

    public interface InvoiceListFilterListener {
        void onApply(int[] config);
    }

    public InvoiceListFilterDialog(@NonNull Context context, int[] filterConfig, InvoiceListFilterListener listener) {
        super(context);
        this.listener = listener;
        View dialogView = getLayoutInflater().inflate(R.layout.invoice_filter_dialog, null);
