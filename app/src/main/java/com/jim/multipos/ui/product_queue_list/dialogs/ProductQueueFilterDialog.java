...
public class ProductQueueFilterDialog extends Dialog {
    ...
    public ProductQueueFilterDialog(@NonNull Context context, int[] filterConfig, ProductQueueFilterListener listener) {
        super(context);
        this.listener = listener;
        View dialogView = getLayoutInflater().inflate(R.layout.product_queue_dialog, null);
