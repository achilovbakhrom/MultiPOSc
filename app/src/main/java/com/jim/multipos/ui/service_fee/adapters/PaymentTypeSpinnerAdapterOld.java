...
public class PaymentTypeSpinnerAdapterOld extends ArrayAdapter {
    private List<PaymentType> paymentTypes;
    private LayoutInflater inflater;

    public PaymentTypeSpinnerAdapterOld(@NonNull Context context, int resource, @NonNull List objects) {
