...
public class ProductsPresenterImpl extends ProductsConnector implements ProductsPresenter {
    ...
    public ProductsPresenterImpl(DatabaseManager databaseManager, RxBus rxBus, PreferencesHelper preferencesHelper, RxBusLocal rxBusLocal) {
    ...
    @Override
    public void saveProduct(String name, String barcode, String sku, String price, String cost, Currency priceCurrency, Currency costCurrency, Unit unit, Vendor vendor, ProductClass productClass, boolean isActive, boolean isTaxed, boolean hasRecipe) {
...
//            product.setVendorId(vendor.getId());
            ...
            product.setTaxed(isTaxed);
            product.setRecipe(hasRecipe);
...
//            newProduct.setVendorId(vendor.getId());
            ...
            newProduct.setTaxed(isTaxed);
            newProduct.setRecipe(hasRecipe);
    ...
    public void checkData() {
        if (this.product != null) {
            ...
            view.setFields(product.getName(), product.getBarcode(), product.getSku(), String.valueOf(product.getPrice()), String.valueOf(product.getCost()),
                    unitPosition, priceCurrencyPosition, costCurrencyPosition, null, classPosition, product.getTaxed(), product.getActive(), product.getRecipe());
    ...
    @Override
    public void onAdvance(String name, String barcode, String sku, String price, String cost, Currency priceCurrency, Currency costCurrency, Unit unit, Vendor vendor, ProductClass productClass, boolean isActive, boolean isTaxed, boolean hasRecipe) {
        if (this.product == null) {
